...
--
-- Host: localhost    Database: ipt_system_db
-- ------------------------------------------------------
...
CREATE TABLE `tasks` (
  ...
  `assigned_to` varchar(1000) NOT NULL DEFAULT 'Everyone',
...
INSERT INTO `users` VALUES (1,'Tristan','$2y$10$CZoSgiR.ayam4ksalR9f6OttOgQV7B9q/K2m24RoEVJ6QD61gk1Ti');
...
-- Dump completed on 2026-04-27 11:35:36
